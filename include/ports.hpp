...
namespace ports
{
    ...
    namespace localization
    {
        ...
        constexpr auto ROTATION_HORIZONTAL = 0;
        ...
        namespace settings
        {
            ...
            constexpr auto ODOMETRY_DIST_FROM_CENTER_VERTICAL = 0; //The horizontal offset of the tracking wheel from the center of the robot in inches.
