...
ts::auton elims_left_old = ts::auton("ELIM LEFT", elims_left_auton);
ts::auton elims_left_dsr_old = ts::auton("ELIM LEFT DSR", elims_left_dsr_auton);
ts::auton elims_right_old = ts::auton("ELIM RIGHT DSR", elims_right_auton);